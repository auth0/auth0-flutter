...
**Fixed**
- refactor: Move darwin native sources into a canonical Sources/ tree [\#894](https://github.com/auth0/auth0-flutter/pull/894) ([NandanPrabhu](https://github.com/NandanPrabhu))
