...
class CredentialsManagerException extends Auth0Exception {
  ...
  factory CredentialsManagerException.fromPlatformException(final PlatformException e) {
    final Map<String, dynamic> errorDetails = e.detailsMap;

    return CredentialsManagerException(
        e.code, e.messageString, errorDetails);
  }
}
