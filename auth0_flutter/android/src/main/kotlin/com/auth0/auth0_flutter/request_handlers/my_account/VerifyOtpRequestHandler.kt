...
private const val MY_ACCOUNT_VERIFY_OTP_METHOD =
    "myAccount#verifyOtp"

class VerifyOtpRequestHandler : MyAccountRequestHandler {
    override val method: String = MY_ACCOUNT_VERIFY_OTP_METHOD
    ...
    override fun handle(
        ...
        assertHasProperties(
            listOf("id", "authSession", "otp"), request.data
        )
        ...
        client.verifyOtp(id, otp, authSession)
            .start(object :
