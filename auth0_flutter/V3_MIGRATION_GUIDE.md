...
Additionally, Android Web Auth now recovers login results across configuration
changes and process death (via `WebAuthProvider.registerCallbacks`). This is an
internal improvement and requires no changes to your code.
